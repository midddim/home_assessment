...
test.describe('Course Details page', () => {
  test('has title and rating', {tag: ['@smoke', '@65ca87a7']}, async ({ courseDetailsPage }) => {
  ...
  test('search for courses on a specific topic', {tag: ['@smoke', '@76ac3a7c']}, async ({ courseDetailsPage }) => {
